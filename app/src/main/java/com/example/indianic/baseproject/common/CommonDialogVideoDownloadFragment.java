 ...
 */
 ...
 public  class CommonDialogVideoDownloadFragment extends DialogFragment {


    private ImageView ivProifile;

    public static CommonDialogVideoDownloadFragment newInstance() {
        CommonDialogVideoDownloadFragment f = new CommonDialogVideoDownloadFragment();
        return f;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_common_dialog_video_download, container, false);
