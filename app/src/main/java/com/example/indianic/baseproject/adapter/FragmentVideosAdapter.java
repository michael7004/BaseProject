...
public class FragmentVideosAdapter extends RecyclerView.Adapter<FragmentVideosAdapter.MyViewHolder> {
    ...
    public FragmentVideosAdapter(Context context, ArrayList<String> horizontalList, FragmentManager manager) {
                        ...
                        switch (item.getItemId()) {
                            case R.id.menu2:
                                ...
                                if (MyVideosFragment.isVideos) {
                                    ...
                                    Uri music_uri = Uri.parse("http://mosaicdesigns.in/assets/videodownloads/8.mp4");
